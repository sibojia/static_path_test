...
module Another
  class Application < Hanami::Application
    configure do
      ...
      #
      # sessions :cookie, secret: ENV['ANOTHER_SESSIONS_SECRET']
      ...
      #
      layout :application # It will load Another::Views::ApplicationLayout
      ...
      # Configure the code that will yield each time Another::Action is included
      ...
      # Configure the code that will yield each time Another::View is included
      # This is useful for sharing common functionality
      #
      # See: http://www.rubydoc.info/gems/hanami-view#Configuration
      view.prepare do
        include Hanami::Helpers
        include Another::Assets::Helpers
      end
    end
